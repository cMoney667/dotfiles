...
- 1. Defensive guards for impossible cases
- 1. Premature abstraction
- 1. Comment pollution
- 1. Code duplication instead of reuse
- 1. Hallucinated APIs and packages
- 1. Generic, intent-less naming
- 1. Long functions doing many things
- 1. Parameter explosion
-  1. Inconsistency with surrounding code
-  1. Dead code, unused imports, half-implementations
-  1. Declares success with mock fallbacks in production code
-  1. Plausible-but-wrong code
-  1. YAGNI violations through speculative configurability
-  1. New dependency for trivial work
